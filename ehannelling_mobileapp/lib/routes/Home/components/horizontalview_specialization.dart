...
class HorizontalViewSpecialization extends StatefulWidget{
  final double height;
  final Future<List<Specialization>> specializationIdandType;
  const HorizontalViewSpecialization(this.height,this.specializationIdandType);
...
class _HorizontalViewState extends State<HorizontalViewSpecialization > {
        ...
        child:        GestureDetector(
                  onTap: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SpecializationGrid(),
                        ));
              ...
              Container(
                ...
                child: FutureBuilder(
                    future: widget.specializationIdandType,
