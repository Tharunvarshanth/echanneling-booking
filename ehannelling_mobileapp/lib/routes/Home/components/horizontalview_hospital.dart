...
class HorizontalViewHospital extends StatefulWidget{
  final double height;
  final Future<List<Hospital>> hospitalIdandName;
  const HorizontalViewHospital(this.height,this.hospitalIdandName );
...
class _HorizontalViewState extends State<HorizontalViewHospital > {
    ...
    return  SliverList(
        delegate: SliverChildListDelegate(
            ...
            Tooltip(
              ...
              child: FutureBuilder(
                  future: widget.hospitalIdandName,
